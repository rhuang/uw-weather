var publisherRequest = require('./PublisherRequest'),
...
exports.get = function(req, res, callback) {
    publisherRequest.get('http://api.uwaterloo.ca/public/v1/?key=' + configs.weatherKey + '&service=weather&output=json', {}, function(err, data) {
        if (err) w.error(err);
        else callback(data);
    });
};
